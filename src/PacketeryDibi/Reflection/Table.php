...
class Table
{
	...
	public function __construct(PacketeryDibi\Reflector $reflector, array $info)
	{
	...
	public function getColumn($name)
	{
		...
		if (isset($this->columns[$l])) {
			...
			throw new PacketeryDibi\Exception("Table '$this->name' has no column '$name'.");
		}
	}
