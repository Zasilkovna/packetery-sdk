...
namespace PacketeryDibi\Reflection;
...
class Column
{
	...
	/** @var PacketeryDibi\Reflector|null when created by Result */
	private $reflector;
	...
	public function __construct(PacketeryDibi\Reflector $reflector = null, array $info)
	{
	...
	public function getTable()
	{
		if (empty($this->info['table']) || !$this->reflector) {
			throw new PacketeryDibi\Exception('Table is unknown or not available.');
		}
	...
	{
		return PacketeryDibi\Helpers::getTypeCache()->{$this->info['nativetype']};
	}
