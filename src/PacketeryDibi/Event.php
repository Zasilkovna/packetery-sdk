...
class Event
{
	...
	public function __construct(Connection $connection, $type, $sql = null)
	{
		...
		\packetery_dibi::$elapsedTime = null;
		\packetery_dibi::$numOfQueries++;
		\packetery_dibi::$sql = $sql;
	}
	...
	public function done($result = null)
	{
		...
		$this->time += microtime(true);
		\packetery_dibi::$elapsedTime = $this->time;
		\packetery_dibi::$totalTime += $this->time;
		return $this;
	}
}
