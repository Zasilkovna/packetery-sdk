 ...
 */
class Sqlite3Driver implements PacketeryDibi\Driver, PacketeryDibi\ResultDriver
{
	...
	public function __construct()
	{
		if (!extension_loaded('sqlite3')) {
			throw new PacketeryDibi\NotSupportedException("PHP extension 'sqlite3' is not loaded.");
		}
	}
	...
	public static function createException($message, $code, $sql)
	{
		if ($code !== 19) {
			...
			return new PacketeryDibi\ConstraintViolationException($message, $code, $sql);
		}
	}
	...
	public function applyLimit(&$sql, $limit, $offset)
	{
		if ($limit < 0 || $offset < 0) {
			...
			$sql .= ' LIMIT ' . ($limit === null ? '-1' : PacketeryDibi\Helpers::intVal($limit))
