 ...
 * @internal
 */
class MySqlReflector implements PacketeryDibi\Reflector
{
	use PacketeryDibi\Strict;

	/** @var PacketeryDibi\Driver */
	private $driver;


	public function __construct(PacketeryDibi\Driver $driver)
	{
		$this->driver = $driver;
	}
	...
	public function getForeignKeys($table)
	{
		...
		if ($data['ENGINE'] !== 'InnoDB') {
			throw new PacketeryDibi\NotSupportedException("Foreign keys are not supported in {$data['ENGINE']} tables.");
		}
