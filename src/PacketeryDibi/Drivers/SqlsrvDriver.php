 ...
 */
class SqlsrvDriver implements PacketeryDibi\Driver, PacketeryDibi\ResultDriver
{
	...
	public function __construct()
	{
		if (!extension_loaded('sqlsrv')) {
			throw new PacketeryDibi\NotSupportedException("PHP extension 'sqlsrv' is not loaded.");
		}
	}
	...
	public function connect(array &$config)
	{
		...
		if (!is_resource($this->connection)) {
			$info = sqlsrv_errors();
			throw new PacketeryDibi\DriverException($info[0]['message'], $info[0]['code']);
		}
	...
	public function query($sql)
	{
		...
		if ($res === false) {
			$info = sqlsrv_errors();
			throw new PacketeryDibi\DriverException($info[0]['message'], $info[0]['code'], $sql);
